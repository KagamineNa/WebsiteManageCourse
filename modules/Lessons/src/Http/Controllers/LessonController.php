...
class LessonController extends Controller
{
    ...
    public function __construct(CoursesRepositoryInterface $coursesRepository, LessonsRepositoryInterface $lessonRepository, VideoRepositoryInterface $videoRepository, DocumentRepositoryInterface $documentRepository)
    {
    ...
    public function update(Request $request, $lessonId)
    {
        ...
        return redirect()->route('admin.lessons.edit', $lessonId)->with('msg', 'Cập nhật bài giảng thành công');
    }
    ...
    public function delete(Request $request, $lessonId)
    {
        ...
        return redirect()->route('admin.lessons.index', $lesson->course_id)->with('msg', 'Xóa bài giảng thành công');
    }
