...
class StudentController extends Controller
{
    ...
    public function store(StudentRequest $request)
    {
        ...
        return redirect()->route('admin.students.index')->with('msg', 'Thêm học viên thành công');
    }
    ...
    public function update(StudentRequest $request, $id)
    {
        ...
        return back()->with('msg', 'Cập nhật học viên thành công');
    }
    ...
    public function delete($id)
    {
        ...
        */
        ...
        return back()->with('msg', 'Xóa học viên thành công');
    }
}