                        ...
                        <div class="course-video mb-4" id="author">
                            <div class="d-flex">
                                <div class="flex-shrink-0">
                                    <img src="{{ $course->teacher->image }}" alt="" class="rounded-circle"
                                        style="width: 80px;">
                                </div>
                                <div class="flex-grow-1 ms-3">
                                    <p>Giảng viên</p>
                                    <h4 class="mt-2"><a
                                            href="/giang-vien/{{ $course->teacher->slug }}">{{ $course->teacher->name }}</a>
                                    </h4>
                                </div>
                            </div>
                        ...
                        <div class="group-text">
                            ...
                            @if (auth('students')->user())
                                <button class="payment">
                                    <a href="{{ route('courses.checkout', ['id' => $course->id]) }} "
                                        style="color: white">đặt
                                        mua khóa
                                        học</a>
                                </button>
                            @endif
