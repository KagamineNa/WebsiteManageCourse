            ...
            <div class="col-6">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control title {{ $errors->has('name') ? 'is-invalid' : '' }}"
                        id="name" name="name" placeholder="Nhập tên..." value="{{ old('name') ?? $course->name }}">
                    @error('name')
            ...
            <div class="col-6">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control slug {{ $errors->has('slug') ? 'is-invalid' : '' }}"
                        id="slug" name="slug" placeholder="Slug..." value="{{ old('slug') ?? $course->slug }}">
                    @error('slug')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="col-6">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control {{ $errors->has('price') ? 'is-invalid' : '' }}"
                        id="price" name="price" placeholder="Giá khóa học..."
            ...
            <div class="col-6">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control {{ $errors->has('sale_price') ? 'is-invalid' : '' }}"
                        id="sale_price" name="sale_price" placeholder="Giá khuyến mãi..."
            ...
            <div class="col-6">
                <div class="mb-3">
                    ...
                    <select name="is_document" id="is_document"
                        ...
                        <option value="0"
                            {{ old('is_document') == 0 || $course->is_document == 0 ? 'selected' : '' }}>Không</option>
                        <option value="1"
                            {{ old('is_document') == 1 || $course->is_document == 1 ? 'selected' : '' }}>Có</option>
                    </select>
                    @error('is_document')
                        <div class="invalid-feedback">
                            {{ $message }}
            ...
            <div class="col-6">
                <div class="mb-3">
                    ...
                    <select name="status" id="status"
                        ...
                        <option value="0" {{ old('status') == 0 || $course->status == 0 ? 'selected' : '' }}>Chưa ra
                            mắt</option>
                        <option value="1" {{ old('status') == 1 || $course->status == 1 ? 'selected' : '' }}>Đã ra mắt
                        </option>
                    </select>
                    @error('status')
                        <div class="invalid-feedback">
            ...
            <div class="col-12">
                <div class="mb-3">
                    ...
                    <textarea name="detail" class= "form-control ckeditor {{ $errors->has('detail') ? 'is-invalid' : '' }}" id="detail"
                        cols="30" rows="10" placeholder="Nội dung...">{{ old('detail') ?? $course->detail }}</textarea>
                    @error('detail')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="col-12">
                <div class="mb-3">
                    ...
                    <textarea name="supports" class= "form-control {{ $errors->has('supports') ? 'is-invalid' : '' }}" id="supports"
                        cols="30" rows="10" placeholder="Hỗ trợ...">{{ old('supports') ?? $course->supports }}</textarea>
                    @error('supports')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                    ...
                    <div class="row align-items-end">
                        <div class="col-7">
                            ...
                            <input type="text"
                                ...
                                name="thumbnail" placeholder="Ảnh đại diện..."
